...
namespace BLL
{
    public class Paises : ClaseMaestra
    {
        ...
        public override bool Eliminar()
        {
            ...
            try
            {
                retorno = Conexion.Ejecutar(string.Format("delete from Paises where PaisId = {0}", this.PaisId));
            }
            catch (Exception)
            {
        ...
        public override DataTable Listado(string Campos, string Condicion, string Orden)
        {
            ...
            try
            {
                return Conexion.ObtenerDatos(string.Format("select " + Campos + " From Paises where " + Condicion + " " + Orden));
            }
            catch (Exception ex)
            {
