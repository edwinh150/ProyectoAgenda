                    ...
                    <div class="col-md-12">
                            <div class="form-group">
                                <div class="col-md-2 col-xs-2">
                                    <asp:Label ID="Label5" For="TipoCompaniaIdTextBox" runat="server" Font-Bold="true" Text="Id por Tipo de Compañia"></asp:Label>
                                </div> 
                                <div id="TipoCompaniaIdDiv" runat="server" class="col-md-8 col-xs-8">
                                    <asp:TextBox ID="TipoCompaniaIdTextBox" MaxLength="4" runat="server" CssClass="form-control" placeholder="Escriba un Id" TextMode="Search" Font-Bold="True"></asp:TextBox>
                                </div>
                                <div class="col-md-2 col-xs-2">
