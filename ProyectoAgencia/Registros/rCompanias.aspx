                        ...
                        <div class="form-inline" role="form">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <asp:TextBox ID="DescripcionTextBox" runat="server" CssClass="form-control" placeholder="Escriba una Compañia"></asp:TextBox>
                                    <p class="help-block">
                                         <asp:requiredfieldvalidator id="RequiredFieldValidator1" ValidationGroup="GuardarButton" forecolor="Red" errormessage="Por Favor Entre una Compañia" controltovalidate="DescripcionTextBox" runat="server">
