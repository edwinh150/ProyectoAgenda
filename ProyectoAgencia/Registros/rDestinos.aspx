<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rDestinos.aspx.cs" Inherits="ProyectoAgencia.Registros.rDestinos" %>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Registro de Destinos</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
        <div class="panel panel-primary">
        <div class="panel-heading">Registros de Destinos</div>
