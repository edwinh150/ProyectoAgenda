<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="rTipoUsuarios.aspx.cs" Inherits="ProyectoAgencia.Registros.rTipoUsuarios" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="panel-heading">Registros de Tipo de Usuarios</div>
                ...
                <h3>Ingrese Sus Datos</h3>
                    <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div id="TipoUsuarioIdDiv" runat="server" class="col-md-8 col-xs-8">
                                    <asp:TextBox ID="TipoUsuarioIdTextBox" MaxLength="4" runat="server" CssClass="form-control" placeholder="Escriba un Id" TextMode="Search" Font-Bold="True"></asp:TextBox>
                                </div>
                                <div class="col-md-2 col-xs-2">
