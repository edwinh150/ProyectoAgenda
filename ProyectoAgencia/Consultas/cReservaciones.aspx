<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cReservaciones.aspx.cs" Inherits="ProyectoAgencia.Consultas.cReservaciones" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Consulta de Reservaciones</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
    <div class="panel panel-primary">
        <div class="panel-heading">Consultar de Reservaciones</div>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 col-md-2">
                             <asp:DropDownList ID="ReservacionDropDownList" CssClass="form-control" runat="server" Height="38px">
                                 <asp:ListItem Value="ReservacionId">Id de Reservacion</asp:ListItem>
