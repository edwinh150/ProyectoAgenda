<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cTipoCategorias.aspx.cs" Inherits="ProyectoAgencia.Consultas.cTipoCategorias" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Consulta de Tipo de Categorias</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
    <div class="panel panel-primary">
        <div class="panel-heading">Consultar de Tipo de Categorias</div>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 col-md-2">
                             <asp:DropDownList ID="TipoCategoriaDropDownList" CssClass="form-control" runat="server" Height="38px">
