<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCategorias.aspx.cs" Inherits="ProyectoAgencia.Consultas.cCategorias" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Consulta de Categorias</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
    <div class="panel panel-primary">
        <div class="panel-heading">Consultar de Categorias</div>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 col-md-2">
                             <asp:DropDownList ID="CategoriaDropDownList" CssClass="form-control" runat="server" Height="38px">
                                 <asp:ListItem Value="CategoriaId">Id de Categorias</asp:ListItem>
