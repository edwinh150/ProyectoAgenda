<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cDestinos.aspx.cs" Inherits="ProyectoAgencia.Consultas.cDestinos" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Consulta de Destinos</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
    <div class="panel panel-primary">
        <div class="panel-heading">Consultar de Destinos</div>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 col-md-2">
                             <asp:DropDownList ID="DestinoDropDownList" CssClass="form-control" runat="server" Height="38px">
                                 <asp:ListItem Value="DestinoId">Id de Destinos</asp:ListItem>
                                 <asp:ListItem Value="Descripcion">Descripcion</asp:ListItem>
                                 <asp:ListItem Value="TipoDestinoId">Id de TipoDestinos</asp:ListItem>
                             </asp:DropDownList>
                        </div>
