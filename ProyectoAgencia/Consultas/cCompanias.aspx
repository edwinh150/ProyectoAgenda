<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cCompanias.aspx.cs" Inherits="ProyectoAgencia.Consultas.cCompanias" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Consulta de Compañias</li>
                </ol>
            </div>
        </div>
        <!-- /.row -->
    <div class="panel panel-primary">
        <div class="panel-heading">Consultar de Compañias</div>
            ...
            <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-2 col-md-2">
                             <asp:DropDownList ID="CompaniaDropDownList" CssClass="form-control" runat="server" Height="38px">
                                 <asp:ListItem Value="CompaniaId">Id de Compañias</asp:ListItem>
